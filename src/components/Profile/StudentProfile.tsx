  ...
  return (
    <>
        ...
        {!isEditing ? (
          <div>
            <div className="flex justify-between items-start mb-6">
              <div>
                <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">{user.username}</h1>
      ...
      <div className="bg-slate-800/80 border-2 border-slate-700 rounded-2xl shadow-lg shadow-black/30 p-6 sm:p-8">
        <h2 className="text-2xl font-bold text-white mb-4">Answers by {user.username}</h2>
        {answers.length === 0 ? (
            ...
            {answers.map((answer: any) => (
              ...
              >
                <div className="flex justify-between items-start gap-4">
                  <div className="flex-1">
                    {answer.isAccepted && (
                      <p className="text-sm font-semibold text-green-400 mb-2">✓ Accepted</p>
                    )}
                    <Link
