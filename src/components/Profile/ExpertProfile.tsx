  ...
  return (
    <>
        ...
        {!isEditing ? (
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div className="bg-slate-700/50 rounded-lg p-4 border border-slate-600">
                <span className="font-bold text-cyan-400 text-lg">✓ {verifiedAnswers}</span>
      ...
      <div className="bg-slate-800/80 border-2 border-slate-700 rounded-2xl shadow-lg shadow-black/30 p-6 sm:p-8 mb-6">
        <h2 className="text-2xl font-bold text-white mb-4">Questions by {user.username}</h2>
        {questions.length === 0 ? (
      ...
      <div className="bg-slate-800/80 border-2 border-slate-700 rounded-2xl shadow-lg shadow-black/30 p-6 sm:p-8 mb-6 border-t-4 border-cyan-500">
            ...
            {answers.map((answer: any) => (
              <div
                ...
                className={`p-4 bg-slate-700/50 rounded-lg border-l-4 ${
                  answer.isAccepted ? 'border-cyan-500 bg-cyan-500/10' : 'border-slate-600'
                }`}
              >
                <div className="flex justify-between items-start gap-4">
                  <div className="flex-1">
